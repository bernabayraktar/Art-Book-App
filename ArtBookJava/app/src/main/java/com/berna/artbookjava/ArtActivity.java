...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")) {
            ...
            try {
                ...
                //yazılan String[] dizisi ? yerine geçecektir. Bu şekilde filtreleme yaparız.
    ...
    public void save(View view) {
        ...
        //MainActivity e geri dönüyoruz.

        Intent intent = new Intent(ArtActivity.this, MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); //içinde bulunulan activity de dahil olmak üzere tüm activity lerin kapatılması sağlanır.
